...
function App() {
  ...
  React.useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      if (engine.finished()) { setPlaying(false); return; }
  ...
  return <div className="app">
    <header><div><strong>Trading Research</strong><span className="badge">REPLAY</span></div><div className="symbol">SYNTH / 5m</div></header>
